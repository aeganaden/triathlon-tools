...
const CardStats = React.forwardRef<HTMLDivElement, CardStatsProps>(
  ({ title, icon, content, subtitle, className, color = "default" }, ref) => {
    ...
    const colorVariants = {
      ...
      lightgreen:
        "border-green-200 bg-green-50 dark:border-green-600 dark:bg-green-800/30",
      yellow:
      ...
      blue: "border-blue-300 bg-blue-100 dark:border-blue-700 dark:bg-blue-900/40",
      gray: "border-gray-300 bg-gray-100 dark:border-gray-700 dark:bg-gray-900/40",
      default: "",
    };
